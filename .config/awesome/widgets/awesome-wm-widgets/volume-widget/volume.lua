...
local utils = require("widgets.awesome-wm-widgets.volume-widget.utils")
...
local widget_types = {
    ...
    custom = require("widgets.awesome-wm-widgets.volume-widget.widgets.custom"),
    custom_small = require("widgets.awesome-wm-widgets.volume-widget.widgets.custom_small")
}
local volume = {}
