-- Adapted from https://github.com/streetturtle/awesome-wm-widgets/tree/master/net-speed-widget
...
local function worker(user_args)
    ...
    local update_widget = function(widget, stdout)
        ...
        widget:set_rx_text(format_speed(speed_rx))
        widget:set_tx_text(format_speed(speed_tx))
